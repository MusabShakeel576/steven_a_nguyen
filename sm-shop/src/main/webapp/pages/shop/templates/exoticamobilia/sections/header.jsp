...
<script type="text/html" id="customerLoggedInAccountTemplate">
		...
		<ul class="dropdown-menu dropdown-menu-right dropdown-animation">
				...
				<li>
                    <a onClick="javascript:location.href='<c:url value="/shop/customer/storecredit.html" />';" href="#"><i class="fa fa-user"></i><s:message code="label.customer.storecredit" text="Store Credit"/></a>
                </li>
				<li>
