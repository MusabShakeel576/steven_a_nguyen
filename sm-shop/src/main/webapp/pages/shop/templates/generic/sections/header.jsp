			...
			<ul>
				<li class="click_menu"><a href="#"><s:message code="label.generic.welcome" text="Welcome" /> <span>{{firstName}}</span><i class="fa fa-angle-down"></i></a>
					<ul class="click_menu_show">
						...
						<li><a href="#" onClick="javascript:location.href='<c:url value="/shop/customer/storecredit.html" />';" href="#"><s:message code="label.customer.storecredit" text="Store Credit"/></a></li>
